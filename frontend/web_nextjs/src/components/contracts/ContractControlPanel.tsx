    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-white/90 via-indigo-50/50 to-purple-50/50 backdrop-blur-xl rounded-3xl border border-white/20 p-6 shadow-xl shadow-indigo-100/50">
      ...
      <div className="relative z-10 flex flex-col gap-6">
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={onRefresh}
            className="group relative overflow-hidden inline-flex items-center gap-3 px-6 py-4 rounded-2xl bg-white/90 text-indigo-700 border border-indigo-200/50 hover:bg-indigo-50 hover:border-indigo-300 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 backdrop-blur-sm"
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-3">
              <div className="p-2 rounded-xl bg-gradient-to-r from-indigo-100 to-indigo-200 group-hover:from-indigo-200 group-hover:to-indigo-300 transition-all duration-300">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                </svg>
              </div>
              <span className="font-bold text-lg">🔄 Làm mới</span>
            </div>
          </button>
          
          <Link 
            href="/import-document" 
            className="group relative overflow-hidden inline-flex items-center gap-3 px-6 py-4 rounded-2xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
          >
            ...
            <div className="relative z-10 flex items-center gap-3">
              ...
              <span className="font-bold text-lg">✨ Tạo hợp đồng</span>
            </div>
          </Link>
          </div>
        </div>
            ...
            <div className="relative bg-white/60 backdrop-blur-sm rounded-2xl border border-white/30 p-6 shadow-lg">
              ...
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 border border-indigo-200">
                  ...
                  <button
                    ...
                    className="text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-100 px-3 py-1.5 rounded-lg transition-all duration-200 font-medium"
                  >
                    ✕ Bỏ chọn tất cả
                  </button>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <button
                  ...
                  className="group relative overflow-hidden inline-flex items-center justify-center gap-3 px-5 py-3 rounded-2xl bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 text-sm font-bold"
                ...
                <button
                  ...
                  className="group relative overflow-hidden inline-flex items-center justify-center gap-3 px-5 py-3 rounded-2xl bg-gradient-to-r from-green-500 to-green-600 text-white hover:from-green-600 hover:to-green-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 text-sm font-bold"
                ...
                <button
                  ...
                  className="group relative overflow-hidden inline-flex items-center justify-center gap-3 px-5 py-3 rounded-2xl bg-gradient-to-r from-red-500 to-red-600 text-white hover:from-red-600 hover:to-red-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 text-sm font-bold"
